...
class RecoilControlApp:
    def __init__(self, root):
        ...
        self.running = False
        self.shooting = False
        self.rapid_fire_active = threading.Event()  # Initialize as Event instead of boolean
    ...
    def run_rapid_fire(self):
        while self.rapid_fire_active.is_set():
            ...
            # Wait for the specified interval or until the event is cleared
            self.rapid_fire_active.wait(config["rapid_fire_interval"] / 1000)  # Convert ms to seconds
